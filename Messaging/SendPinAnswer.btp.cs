namespace Messaging
{
    ...
    public sealed class SendPinAnswer : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"pe=\"xsd:string\">Messaging.PinAnswer</Value>            </Property>            <Property Name=\"Traile"+
"rSpecName\" />            <Property Name=\"TargetCharset\">              <Value xsi:type=\"xsd:string\" /"+
">            </Property>            <Property Name=\"TargetCodePage\">              <Value xsi:type=\"x"+
"sd:int\">0</Value>            </Property>            <Property Name=\"PreserveBom\">              <Valu"+
"e xsi:type=\"xsd:boolean\">false</Value>            </Property>            <Property Name=\"HiddenPrope"+
"rties\">              <Value xsi:type=\"xsd:string\">TargetCodePage</Value>            </Property>     "+
"     </Properties>          <CachedDisplayName>Flat file assembler</CachedDisplayName>          <Cac"+
"hedIsManaged>true</CachedIsManaged>        </Component>      </Components>    </Stage>    <Stage>   "+
"   <PolicyFileStage _locAttrData=\"Name\" _locID=\"3\" Name=\"Encode\" minOccurs=\"0\" maxOccurs=\"-1\" execMe"+
"thod=\"All\" stageId=\"9d0e4108-4cce-4536-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stag"+
"es></Document>";
        
        private const string _versionDependentGuid = "f8dc7ecd-a544-486a-a1e6-3afb2b055e22";
        
        public SendPinAnswer()
        {
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">Messaging.PinAnswer</Val"+
"ue>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"TargetCharset\">      <V"+
"alue xsi:type=\"xsd:string\" />    </Property>    <Property Name=\"TargetCodePage\">      <Value xsi:typ"+
"e=\"xsd:int\">0</Value>    </Property>    <Property Name=\"PreserveBom\">      <Value xsi:type=\"xsd:bool"+
"ean\">false</Value>    </Property>    <Property Name=\"HiddenProperties\">      <Value xsi:type=\"xsd:st"+
"ring\">TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
