namespace Messaging
{
    ...
    public sealed class SendUserID : Microsoft.BizTalk.PipelineOM.SendPipeline
    {
...
"pe=\"xsd:string\">Messaging.UserID</Value>            </Property>            <Property Name=\"TrailerSp"+
"ecName\" />            <Property Name=\"TargetCharset\">              <Value xsi:type=\"xsd:string\" />  "+
"          </Property>            <Property Name=\"TargetCodePage\">              <Value xsi:type=\"xsd:"+
"int\">0</Value>            </Property>            <Property Name=\"PreserveBom\">              <Value x"+
"si:type=\"xsd:boolean\">false</Value>            </Property>            <Property Name=\"HiddenProperti"+
"es\">              <Value xsi:type=\"xsd:string\">TargetCodePage</Value>            </Property>        "+
"  </Properties>          <CachedDisplayName>Flat file assembler</CachedDisplayName>          <Cached"+
"IsManaged>true</CachedIsManaged>        </Component>      </Components>    </Stage>    <Stage>      "+
"<PolicyFileStage _locAttrData=\"Name\" _locID=\"3\" Name=\"Encode\" minOccurs=\"0\" maxOccurs=\"-1\" execMetho"+
"d=\"All\" stageId=\"9d0e4108-4cce-4536-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stages>"+
"</Document>";
        
        private const string _versionDependentGuid = "2a622cd3-1cc5-4a22-8752-40c17d621b42";
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">Messaging.UserID</Value>"+
"    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"TargetCharset\">      <Valu"+
"e xsi:type=\"xsd:string\" />    </Property>    <Property Name=\"TargetCodePage\">      <Value xsi:type=\""+
"xsd:int\">0</Value>    </Property>    <Property Name=\"PreserveBom\">      <Value xsi:type=\"xsd:boolean"+
"\">false</Value>    </Property>    <Property Name=\"HiddenProperties\">      <Value xsi:type=\"xsd:strin"+
"g\">TargetCodePage</Value>    </Property>  </Properties></PropertyBag>";
