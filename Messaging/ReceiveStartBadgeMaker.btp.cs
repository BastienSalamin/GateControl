namespace Messaging
{
    ...
    public sealed class ReceiveStartBadgeMaker : Microsoft.BizTalk.PipelineOM.ReceivePipeline
    {
...
"       <Value xsi:type=\"xsd:string\">Messaging.StartBadgeMaker</Value>            </Property>        "+
...
"-83fa-4a5040674ad6\" />      <Components />    </Stage>  </Stages></Document>";
        ...
        private const string _versionDependentGuid = "42694b95-dd84-4a89-97f0-d2a4277a0c28";
...
" />    <Property Name=\"DocumentSpecName\">      <Value xsi:type=\"xsd:string\">Messaging.StartBadgeMake"+
"r</Value>    </Property>    <Property Name=\"TrailerSpecName\" />    <Property Name=\"PreserveHeader\"> "+
